...
app.get('/', function(req, res){
	...
	if(req.session.userName)
		res.render('index', {user: req.session.userName,symptom1:symptom1,symptom2:symptom2,symptom3:symptom3});
	else res.render('index',symptom1:symptom1,symptom2:symptom2,symptom3:symptom3);
});
